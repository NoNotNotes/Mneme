...
___
# Colorectal Cancer
1. **Risk Factors**: a high-fat, low-fiber diet
2. **Signs and Symptoms**:
	- Melena from gastrointestinal bleeding.
	- Altered bowel patterns; diarrhea occurs if the cancer is on the ascending colon, constipation occurs if the cancer is on the descending colon, and patterns alternate when the cancer is on the rectum.
	- Abscess formation, fistula formation, obstruction, and perforation are all potential complications of colon cancer.
3. **Treatment**: bowel resection (colostomy, ileostomy)
___
# Endometrial Cancer
1. **Risk Factors**:
