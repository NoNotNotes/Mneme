...
tags:
  ...
  - OB
  - L1
description: "Labor may require induction for postterm babies via the use of oxytocic drugs, prostaglandin gels, amniotomy, etc. Bishop scoring is used to determine readiness for induction."
---
**Reference**:
1. Lecturer (V)
