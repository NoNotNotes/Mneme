...
___
# Stimulants
Drugs that **stimulate or excite the CNS** and have limited use, often only being used for managing [[PSYCH/09#Attention-Deficit Hyperactivity Disorder|ADHD]]. These have a high potential for abuse, most often being **amphetamines** (uppers). These were previously used for weight loss and staying awake, and is now mostly used in recreation.
