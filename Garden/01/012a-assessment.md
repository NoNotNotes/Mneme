...
tags:
  - FUNDA
  - L1
description: The first step of the nursing process that involves collection, organization, validation, and documentation of data in order to determine the client's health status.
---
**Reference**:
1. Lecturer (Tuiza)
